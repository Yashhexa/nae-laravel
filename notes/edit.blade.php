...
@endisset        
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header bg-dark text-white fs-4"><i class="bi bi-pen-fill"></i> {{ __('Edit Note') }}  @if(isset($deal)) for Deal ID: <a href="/deals/{{$deal->id}}">{{$deal->id}}</a> @endif</div>
