...
@section('content') 
 ...
 {{$category->name}} </h1>
    ...
    @else
    <div class="col-md-12 mb-3"><h1 class="text-success fw-light"><i class="bi bi-shop-window"></i> Search products: <span class="text-capitalize text-primary">{{str_replace("-"," ",$cat_name)}}</span></h1>
 </div>
    @endisset
    ...
    @endphp
                ...
                <div class="col-lg-3 col-12">
                 ...
                 <a href="/enclosures/{{$product->url_key}}"> 
                  ...
                  <div class="card-body pt-0 px-0">
                    ...
                    @if(auth()->check())
                        <a href="/3d-configurator/frontend/?productId={{ $product->id }}&userId={{ $userId }}" class="btn btn-primary btn-block">Customize</a>
                    @else
                        <a href="/3d-configurator/frontend/?productId={{ $product->id }}" class="btn btn-primary btn-block">Customize</a>
                    @endif
                </div>
                ...
                @endforeach
                <div class="row p-5"> {{ $products->links('vendor.pagination.plain') }} </div>
