    ...
    <section class="content container">
        <div class="row">
            <div class="col-md-12 mt-4">
                <h1 class="text-success"><i class="bi bi-pencil-square"></i> Edit: <span
                        class="text-primary">{{ $product->name }}</span></h1>
                @includeif('partials.errors')

                <div class="card card-default mb-5">
                    <div class="card-header">
                        <span class="card-title">Product Photos</span>
                    </div>
                    <div class="card-body">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('enclosures.update', $product->id) }}" role="form"
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="tab-3" data-bs-toggle="tab" href="#tabpanel-3"
                                        role="tab" aria-controls="tabpanel-3" aria-selected="false">Associated Products</a>
                                </li>                                
                            </ul>
                            <div class="tab-content pt-2" id="tab-content">
                                ...
                                <div class="tab-pane" id="tabpanel-2" role="tabpanel" aria-labelledby="tab-2">
                                    ...
                                    <div class="tab-pane" id="tabpanel-3" role="tabpanel" aria-labelledby="tab-3">
                                        @include('product.associated')</div>                                    
                            </div>
