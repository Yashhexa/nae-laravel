...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-dark text-white fs-4"><i class="bi bi-buildings-fill"></i> Add new company</div>
                        ...
                        <div class="form-group row mb-2 mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-plus-square"></i> {{ __('Create') }}
                                </button>
                                <a href="{{ route('companies.index') }}" class="btn btn-secondary"><i class="bi bi-x-square"></i> {{ __('Cancel') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
